...
impl Display for SubtitleParserError {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            SubtitleParserError::MalformedUnit(msg) => write!(f, "Malformed subtitle unit: {}", msg),
...
impl SubtitleParser {
    ...
    pub fn parse_file(&mut self, _path: impl AsRef<Path>) -> ParseResult<impl Iterator<Item = UnitResult>> {
        // TODO: Implement this!
        Ok(std::iter::empty())
    }
    ...
    pub fn parse_str<'a>(&mut self, _content: &'a str) -> ParseResult<impl Iterator<Item = UnitResult> + 'a> {
        // TODO: Implement this!
        Ok(std::iter::empty())
    }
}
